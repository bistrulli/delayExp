...
if(Variance1~="none")
    ...
    N1data=load(sprintf("../N1/N1out.mat"));
    N2data=load(sprintf("../N2/N2out.mat"));
    Wdata=load(sprintf("../Workload/roi_profile.mat"));
end
...
legend("N1 istantaneous","N1 setpoint","N2 istantaneous","N2 setpoint","Orientation","horizontal")
grid on;
box on;
